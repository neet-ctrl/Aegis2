...
object GetoIcons {
    ...
    val AppsOutlined = Icons.Outlined.Apps
    ...
    val Automations = Icons.Default.AutoAwesome
    val AutomationsOutlined = Icons.Outlined.AutoAwesome
    val Activity = Icons.Default.History
    val ActivityOutlined = Icons.Outlined.History
    ...
    val Headphones = Icons.Default.Headset
    val HeadphonesOff = Icons.Default.HeadsetOff
    val Nfc = Icons.Default.Nfc
    val Schedule = Icons.Default.Schedule
    val VolumeUp = Icons.Default.VolumeUp
    val SaveAlt = Icons.Default.SaveAlt
    val Restore = Icons.Default.RestoreFromTrash
